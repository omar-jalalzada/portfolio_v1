  ...
  <div id="header">
    ...
    <div class='nav_container'>
      ...
      <div id="sub_nav">
        ...
        <ul  class="<?php if ( $wrapper_class == 'interactive' ) { echo "show";} ?>" >
          <li style="display: none;"class='asda'><a href="project.php?cat=mobile&proj=asda" >Asda</a></li>
          <li style="display: none;"class='life'><a class="row" href="project.php?cat=interactive&proj=life">LifeTechnologies</a></li>
          <li style="display: none;"class='tw'><a class="row" href="project.php?cat=interactive&proj=tw">TicketWeb</a></li>
          <li class='invitrogen'><a class="row" href="project.php?cat=interactive&proj=invitrogen">Invitrogen</a></li>
          <li style="display: none;"class='wasabi'><a class="row" href="project.php?cat=interactive&proj=wasabi">Wasabi Grill</a></li>
          <li class='eats'><a class="row" href="project.php?cat=interactive&proj=eats">Eats</a></li>
        </ul>
        ...
        <ul  class="<?php if ( $wrapper_class == 'mograph|etc' ) { echo "show";} ?>" >
